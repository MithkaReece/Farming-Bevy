...
impl Plugin for UiPlugin {
    fn build(&self, app: &mut App) {
        app.add_systems(Startup, (setup_money_ui, setup_selected_item_ui, setup_inventory_ui));
        app.add_systems(Update, (sync_money_ui,sync_selected_item_ui, sync_inventory_ui));
    }
}
